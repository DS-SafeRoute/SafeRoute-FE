  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        lazy: async () => {
          const { default: TrainingMonitoringDetailPage } =
            await import('@/pages/trainingAnalysis/TrainingMonitoringDetailPage');
          return { Component: TrainingMonitoringDetailPage };
        },
      },
      {
        path: ROUTES.REPORTS,
